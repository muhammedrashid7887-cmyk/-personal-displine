...
const startIndex = code.indexOf('function initAuth() {');
const endIndex = code.indexOf('async function saveGlobalState() {');

if (startIndex !== -1 && endIndex !== -1) {
    code = code.substring(0, startIndex) + newInitAuth + '\n' + code.substring(endIndex);
    fs.writeFileSync('c:/Users/HP/Pictures/Screenshots/displine/app.js', code);
    console.log("Successfully replaced initAuth.");
} else {
